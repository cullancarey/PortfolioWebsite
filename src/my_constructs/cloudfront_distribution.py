                ...
                security_headers_behavior=cloudfront.ResponseSecurityHeadersBehavior(
                    content_security_policy=cloudfront.ResponseHeadersContentSecurityPolicy(
                        content_security_policy=(
                            ...
                            "frame-src 'self' https://www.google.com/recaptcha/ https://assets.calendly.com https://calendly.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net; "
                            "connect-src 'self' https://www.google.com/recaptcha/ https://form.cullancarey.com https://form.develop.cullancarey.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://ep1.adtrafficquality.google; "
                            "base-uri 'self'; "
                            "form-action 'self'; "
